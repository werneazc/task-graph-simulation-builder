========================================================================
    KONSOLENANWENDUNG: 02_vertexBuilder-Projektübersicht
========================================================================

Diese 02_vertexBuilder-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 02_vertexBuilder-Anwendung besteht.


02_vertexBuilder.vcxproj
...
02_vertexBuilder.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 02_vertexBuilder.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
